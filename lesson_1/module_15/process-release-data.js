/* Write a Function named processReleaseData that processes the provided movie
 * release data.
 * 
...
function processReleaseData(data) {
  let hasIdAndTitle = data.filter(movie => movie['id'] && movie['title']);

  let movies = [];
  hasIdAndTitle.forEach(movie => {
